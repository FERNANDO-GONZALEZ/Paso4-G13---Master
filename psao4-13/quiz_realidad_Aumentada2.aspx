<%@ Page Language="VB" AutoEventWireup="false" CodeFile="quiz_realidad_Aumentada2.aspx.vb" Inherits="quizIngles" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <!--Respuesta correcta radioButton1  -->
            <h2>1.Se necesita algun software especial para la realidad Aumentada ?</h2>
            <asp:RadioButton  ID="RadioButton1" CssClass="radio" runat="server" text="SI" GroupName="uno" /> 
            <asp:RadioButton ID="RadioButton2" CssClass="radio" runat="server" text="NO" GroupName="uno" />
        
         </div>

         <div class="flex-container">
        <!--Respuesta correcta radioButton4  -->
            <h2> Como puedo ver la Realidad Aumentada en una Imagen</h2>

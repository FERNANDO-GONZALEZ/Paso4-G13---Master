<%@ Page Language="VB" AutoEventWireup="false" CodeFile="medio_ambiente3.aspx.vb" Inherits="areasdeestudio" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Medio_Ambiente 3</title>

    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no">

    <link rel="stylesheet" type="text/css" href="css/ambiente.css" />
       ...
       <div class="flex-container">
        ...
        <div class="flex-container">
            <div id="uno" class="col-lg-4">
                <img src="img/medio_ambiente2.PNG" alt="" width="120" height="100" />
            </div>
            <div id="ingles"class="col-lg-4">
                <h1> Medio Ambiente 3</h1>

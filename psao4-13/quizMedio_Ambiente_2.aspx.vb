...
Partial Class quizIngles
    ...
    Protected Sub Bustton1_Click(sender As Object, e As EventArgs) Handles Bustton1.Click
        ...
        Dim seleccion As String = "UPDATE registro SET nMedioambiente2 = '" & nota & "' WHERE idEstudiante='" & TextBox1.Text & "'"
    ...
    Protected Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Response.Redirect("medio_ambiente2.aspx")
    End Sub
End Class
